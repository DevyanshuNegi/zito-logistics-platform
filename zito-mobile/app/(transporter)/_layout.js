...
export default function TransporterLayout() {
  return (
    <Tabs
      ...
      <Tabs.Screen
        name="bookings"
        options={{ title: 'Bookings', tabBarIcon: ({ color }) => <TabIcon name="reader-outline" color={color} /> }}
      />
      <Tabs.Screen
        name="finance"
        options={{ title: 'Finance', tabBarIcon: ({ color }) => <TabIcon name="card-outline" color={color} /> }}
      />
    </Tabs>
  );
}
