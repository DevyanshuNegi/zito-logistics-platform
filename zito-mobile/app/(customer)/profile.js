  ...
  return (
    <SafeAreaView style={s.root}>
      <ScrollView contentContainerStyle={s.content}>
        ...
        <View style={s.infoCard}>
          <Text style={s.sectionTitle}>About {BRAND.appName}</Text>
          <Text style={s.about}>
            {BRAND.appName} is the logistics platform by {BRAND.companyName} for booking, tracking,
            warehousing, and transport operations across East Africa.
          </Text>
        </View>
