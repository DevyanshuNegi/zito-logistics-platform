    ...
    return class LoginDto {
        static {
            ...
            _email_decorators = [ApiProperty({
                ...
                }), IsEmail({}, { message: 'Please provide a valid email address' }), IsNotEmpty({ message: 'Email is required' })];
            _password_decorators = [ApiProperty({
                    example: 'password123',
                    description: 'The password of the user',
                }), IsString(), IsNotEmpty({ message: 'Password is required' }), MinLength(6, { message: 'Password must be at least 6 characters long' })];
