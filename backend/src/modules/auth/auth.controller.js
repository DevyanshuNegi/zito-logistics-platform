...
let AuthController = (() => {
    let _classDecorators = [ApiTags('Auth'), Controller('api/v1/auth')];
    ...
    var AuthController = class {
        ...
        static {
            ...
            _login_decorators = [Post('login'), ApiOperation({ summary: 'Login to ZITO platform' }), ApiResponse({ status: 200, description: 'Login successful' })];
            _verifyOtp_decorators = [Post('verify-otp'), ApiOperation({ summary: 'Verify OTP and receive access tokens' }), ApiResponse({ status: 200, description: 'OTP verified, tokens issued' })];
