...
export default function PartnerSelectRolePage() {
  const portal = getPortalConfig('partners');

  return (
    <AuthShell
      eyebrow="Partner Registration"
      title={`Choose your ${portal.productName} account type`}
      subtitle="This partner app is for drivers, agents, transporters, courier companies, and warehouse partners."
      ...
      footer={
        <div className="space-y-2">
          ...
          <p>
            Need the customer or corporate app?{' '}
