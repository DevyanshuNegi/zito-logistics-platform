...
export default function CourierCompanyFleetPage() {
  return (
    <OwnedFleetWorkspace
      ...
      description="Courier operators can register their own vehicles here, blend them with the Zito CFA network when needed, and keep fleet visibility inside the same operations workspace."
