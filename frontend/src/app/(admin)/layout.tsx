...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: 'Trip Management', icon: 'TR', path: '/bookings', roles: ['super_admin', 'admin', 'agency_admin', 'operations', 'support'] },
      { label: 'Assignments', icon: 'AS', path: '/assignments', roles: ['super_admin', 'admin', 'agency_admin', 'operations'] },
      { label: 'Notifications', icon: 'NT', path: '/notifications', roles: ['super_admin', 'admin', 'agency_admin'] },
      { label: 'Complaints', icon: 'CP', path: '/complaints', roles: ['super_admin', 'admin', 'support'] },
      { label: 'Help / SOS', icon: 'HP', path: '/help', roles: ['super_admin', 'support'] },
    ],
  },
  {
    section: 'MANAGEMENT',
    items: [
      { label: 'Drivers', icon: 'DR', path: '/drivers', roles: ['super_admin', 'admin', 'agency_admin', 'operations'] },
      { label: 'Fleet', icon: 'FL', path: '/fleet', roles: ['super_admin', 'admin', 'agency_admin', 'operations'] },
      { label: 'Customers', icon: 'CU', path: '/customers', roles: ['super_admin', 'admin', 'agency_admin', 'support'] },
      { label: 'Transporters', icon: 'TP', path: '/transporters', roles: ['super_admin', 'admin', 'agency_admin'] },
      { label: 'Warehouse', icon: 'WH', path: '/warehouse', roles: ['super_admin', 'admin', 'agency_admin', 'warehouse'] },
      { label: 'Verification', icon: 'VR', path: '/verification', roles: ['super_admin', 'admin'] },
      { label: 'Audit Log', icon: 'AL', path: '/audit-log', roles: ['super_admin', 'admin'] },
    ],
  },
  {
    section: 'FINANCE',
    items: [
      { label: 'Payments', icon: 'PM', path: '/payments', roles: ['super_admin', 'admin', 'finance_admin', 'accounts'] },
      { label: 'Contracts', icon: 'CT', path: '/contracts', roles: ['super_admin', 'admin', 'finance_admin'] },
      { label: 'Reports', icon: 'RP', path: '/reports', roles: ['super_admin', 'admin', 'finance_admin', 'accounts', 'agency_admin'] },
