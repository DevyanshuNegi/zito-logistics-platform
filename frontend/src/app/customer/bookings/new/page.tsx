...
export default function NewBookingPage() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      {step === 1 ? (
        <SurfaceCard title="Cargo and service" description="Pick the service line and vehicle type required by the rate card engine.">
      ...
      {step === 2 ? (
        <SurfaceCard title="Route and contacts" description="Provide the minimum PRD stop data: address, coordinates, and contact details.">
      ...
      {step === 3 ? (
        <SurfaceCard title="Confirm booking" description="Review the request before the backend calculates pricing and creates the booking.">
          <div className="grid gap-4 md:grid-cols-2">
