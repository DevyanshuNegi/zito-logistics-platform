...
const QUICK_ACTIONS = [
  ...
  { href: '/admin/rail-container', label: 'Rail desk', icon: 'RC', helper: 'Corridor, customs, and container control' },
  ...
  { href: '/admin/surge-pricing', label: 'Surge', icon: 'SG', helper: 'Demand-supply multiplier control' },
  { href: '/admin/heatmap', label: 'Heatmap', icon: 'HM', helper: 'Demand zone thresholds and actions' },
  { href: '/admin/retention', label: 'Retention', icon: 'RT', helper: 'CLV, loyalty, and referrals' },
  { href: '/admin/route-optimization', label: 'Routes', icon: 'RO', helper: 'ETA, deviation, and corridor planning' },
  { href: '/admin/notifications', label: 'Notifications', icon: 'NT', helper: 'Operator inbox and acknowledgements' },
